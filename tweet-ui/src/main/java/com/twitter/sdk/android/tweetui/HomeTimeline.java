...
public class HomeTimeline extends BaseTimeline implements Timeline<Tweet> {
    ...
    HomeTimeline(TweetUi tweetUi, Long userId, String screenName, Integer maxItemsPerRequest,
    ...
    public static class Builder {
        ...
        public HomeTimeline build() {
            return new HomeTimeline(tweetUi, userId, screenName, maxItemsPerRequest, includeReplies,
                    includeRetweets);
        }
    }
}
